        ...
        <MenuContainer onClick={toggleMenu} isOpen={isMenuOpen} >
            ...
            <MenuWrapper>
                <Menu>
                    ...
                    <MenuLink to={'משרד ביתי'} smooth={true} duration={500} spy={true} offset={-80} onClick={toggleMenu}> משרד ביתי 🗄️ </MenuLink>
                    <MenuLink to={'ציוד טיולים'} smooth={true} duration={500} spy={true} offset={-80} onClick={toggleMenu}> ציוד טיולים 🏕️ </MenuLink>
