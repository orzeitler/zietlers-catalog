...
export const CategoryData = [
    {
        ...
        items: [
            ...
            {id: '7', name: 'תמונות', description: 'איורים ממוסגרים המחיר לאחת', price: 35, image: pic4, isSold: true, isAvailableInJune: false },
    ...
    },
    {
        ...
        items: [
            ...
            {id: '1513', name: 'נינגה', description: 'מעבד מזון נינגה ' , price: 90, image: ninja, isSold: true, link: 'https://www.ivory.co.il/catalog.php?id=31470'},
    ...
    },
    {
        ...
        items: [
            ...
            {id: '10', name: 'דקל גדול', description: 'דקל בריא בעציץ גדול', price: 200, image: plant3, isSold: true, isAvailableInJune: false },
            {id: '3', name: 'מדף', description: 'מדף מסדרת Cubist של SOHO. כולל עציץ.', price: 100, image: entranceShelf, isSold: true, link: 'https://www.sohocenter.co.il/products/mdf-dkurtibi-cubist'},
            {id: '101', name: 'מדפים משושים', description: '3 מדפים בגדלים שונים', price: 150, image: mesosim, isSold: true, isAvailableInJune: false },
    ...
    },
    {
        ...
        items: [
            ...
            {id: '421', name: 'שעון ספורט suunit', description: 'שעון חדש לגמרי בקופסא נקנה לפני שנתיים לא היה בשימוש מעולם' , price: 500, image: sportWatch, isSold: true, isAvailableInJune: false, link: 'https://www.suunto.com/Support/sports-watches-support/suunto-spartan-sport-wrist-hr/'},
        ]
    },
    {
        ...
        items: [
            ...
            {id: '491', name: 'מכונת כביסה', description: 'מכונת כביסה פתיחה עליונה למסירה' , price:  0, image: washing, isSold: true, isAvailableInJune: true },
