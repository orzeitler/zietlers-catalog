...
export const CategoryData = [
    ...
    },
    {
        ...
        items: [
            ...
            {id: '158', name: 'קורנינג', description: 'כלי קורנינג  בגדלים שונים - המחיר עבור פריט אחד ', price: 15, image: korning, isSold: false, isAvailableInJune: false},
            {id: '158', name: 'קורנינג כלבלבים', description: '8 צלחות קטנות עם איור כלבלב', price: 150, image: doggyKorning, isSold: false, isAvailableInJune: false},
    ...
    },
    {
        ...
        roomPictures: [],
        items: [
            {id: '43', name: 'מזרון זוגי גדול', description: 'מזרון של דוקטור גב תלת שכבתי triple system גודל: 1.60 על 1.90 אפשרות לעזרה בהובלה לאזור הקרוב', price: 1900, image: matress, isSold: false, isAvailableInJune: false, link: 'https://www.dr-gav.co.il/sleep/mattresses/twin-mattresses' },
