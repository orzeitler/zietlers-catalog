...
import light from "../images/living room /light.png";
...
import doggyKorning from "../images/kitchen/doggyKorining.jpeg";
...
import megahetz from "../images/more/megahetz.png"
import mahilk from "../images/more/mahilk.jpeg"
...
export const CategoryData = [
    {
        ...
        items: [
            {id: '13', name: 'שולחן סלון', description: 'שולחן סלון kaza, שני חלקים', price: 650, image: table, isSold: false, isAvailableInJune: false },
            ...
            {id: '46', name: 'שולחן סלון', description: 'שולחן סלון שלושה חלקים של שומרת הזורע' , price: 450, image: livingRoomTable, isSold: false, isAvailableInJune: false },
            ...
            {id: '4', name: 'מראה נפתחת', description: 'מֿראה נפתחת של Nooshka במצב מצויין, נקנתה לפני שנה', price: 1100, image: mirror, isSold: false, isAvailableInJune: false},
            {id: '4', name: 'גוף תאורה', description: 'גוף תאורה צמוד תקרה - חדש לא היה בשימוש', price: 450, image: light, isSold: false, isAvailableInJune: false, link: 'https://www.tlite.co.il/products/68660/'},
        ]
    },
    {
        categoryName: 'מטבח',
        ...
        items: [
            {id: '153', name: 'מיקסר kmix', description: 'מיקסר kMix Picasso מקצועי KENWOOD דגם KMX750WH לבן. נרכש לפני שנה ונשמר כמיקסר ללא גלוטן' , price: 600, image: mikser, isSold: false},
            ...
            {id: '158', name: 'קורנינג', description: 'כלי קורנינג שונים - המחיר עבור חלק אחד ', price: 15, image: korning, isSold: true, isAvailableInJune: false},
            {id: '158', name: 'קורנינג כלבלבים', description: '8 צלחות קטנות עם איור כלבלב', price: 150, image: doggyKorning, isSold: true, isAvailableInJune: false},
            {id: '159', name: 'סיר אינדוקציה ענק', description: 'סיר אינדוקציה 36סמ של חברת Laguiole', price: 70, image: bigPot, isSold: false, isAvailableInJune: false},
            {id: '1599', name: 'מחבתות וסירים', description: 'מחבתות וסירי אינדוקציה מחיר לפריט', price: 25, image: potAndPans, isSold: false, isAvailableInJune: false},
    ...
    },
    {
        ...
        items: [
            ...
            {id: '102', name: 'סלסלות', description: '2 סלסלות קש ניתן לקנות גם חלק', price: 80, image: baskets, isSold: false, isAvailableInJune: false },
    ...
    },
    {
        ...
        roomPictures: [],
        items: [
            {id: '43', name: 'מזרון זוגי גדול', description: 'מזרון של דוקטור גב תלת שכבתי triple system גודל: 1.60 על 1.90', price: 1900, image: matress, isSold: false, isAvailableInJune: false, link: 'https://www.dr-gav.co.il/sleep/mattresses/twin-mattresses' },
            ...
            {id: '502', name: 'מנקה חלונות', description: 'מנקה חלונות חשמלי של חברת jimmy חדש לגמרי' , price: 80, image: glassCleaner, isSold: false, link: 'https://www.banggood.com/JIMMY-VW302-Cordless-Window-Glass-Vacuum-Cleaner-with-Squeegee,Spray-Bottle-p-1536802.html' },
            ...
            {id: '504', name: 'מגהץ אוויר', description: 'מגהץ קיטור אנכי Tefal דגם: DT8150' , price: 130, image: megahetz, isSold: false, isAvailableInJune: false, link: 'https://www.biogaya.co.il/home-appliance/quad-action-dr-gav?gclid=Cj0KCQjw_4-SBhCgARIsAAlegrWPCE2MLQrBRbhSBreOFqsSRyhOdxKPZkuvpt3iSHoQg-1cXfuWDUsaAnLsEALw_wcB' },
